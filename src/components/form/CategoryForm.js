...
export const CategoryForm = (input) => {
  ...
  <button id="category">
    <input class="semibold-12" placeholder="분류하세요" readonly />
  ...
  categoryForm.addEventListener("click", (e) => {
    ...
    if (e.target.closest("li")) {
      ...
      const categoryTextInput = categoryForm.querySelector("#category > input");
      categoryTextInput.value = selectedCategory;
